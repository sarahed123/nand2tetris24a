# usage: python test_07.py [example]?
#        python -m pytest -xv test_07.py
#        python -m pytest -xv test_07.py::unit_test_func
#        python -m pytest -qrfsp test_07.py
import os
import sys
import subprocess
import pytest
...
programs = ['StackArithmetic/SimpleAdd', 'StackArithmetic/StackTest',
